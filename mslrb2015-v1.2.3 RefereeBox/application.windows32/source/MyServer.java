...
/*
  Adapted Server class (Processing)
    - add client authentication
    - remove serverEventMethod nulling
*/
...
public class MyServer implements Runnable {
   ...
   */
  public MyServer(PApplet parent, int port) {
    ...
    try {
      ...
      try {
        clientValidationMethod =
          parent.getClass().getMethod("clientValidation",
                                      new Class[] { MyServer.class,
                                                    Client.class });
      } catch (Exception e) {
        // no such method, or an error.. which is fine, just ignore
